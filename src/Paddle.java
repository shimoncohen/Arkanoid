...
public class Paddle implements Sprite, Collidable, HitNotifier {
    ...
    static final int SPACE_FROM_SIDES = 17;
    ...
    public void moveLeft() {
        if (this.rec.getUpperLeft().getX() >= 0  + SPACE_FROM_SIDES) {
            this.rec.setPosition(new Point(this.rec.getUpperLeft().getX() - this.speed,
    ...
    public void moveRight() {
        if (this.rec.getBottomRight().getX() <= Ass5Game.SCREEN_WIDTH - SPACE_FROM_SIDES) {
            this.rec.setPosition(new Point(this.rec.getUpperLeft().getX() + this.speed,
                    this.rec.getUpperLeft().getY()));
        }
    }
