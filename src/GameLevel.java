...
public class GameLevel implements Animation {
    ...
    public GameLevel(LevelInformation levelInfo, KeyboardSensor ks, AnimationRunner animationRunner,
        ...
        this.shotCounter = 5;
        if (((Background) this.levInfo.getBackground()).getBackgroundColor() == Color.black) {
            this.ballsAndPaddleColor = Color.lightGray;
        } else {
            this.ballsAndPaddleColor = Color.black;
        }
    }
    ...
    public void doOneFrame(DrawSurface d) {
        ...
        this.levInfo.getBackground().drawOn(d);
        this.sprites.drawAllOn(d);
        d.setColor(Color.red);
        d.drawText(20, Ass5Game.SCREEN_HEIGHT - 20, "Press space for a surprise", 20);
        ...
        if (this.blockCount.getValue() == 0) {
            ...
            this.pad = new Paddle(new Rectangle(new Point(Ass5Game.SCREEN_WIDTH / 2 - this.levInfo.paddleWidth() / 2,
                    Ass5Game.SCREEN_HEIGHT - PADDLE_HEIGHT - BORDER_HEIGHT_OR_WIDTH), this.levInfo.paddleWidth(),
    ...
    private void createBallsOnTopOfPaddle() {
        ...
        for (int i = 0; i < this.levInfo.numberOfBalls(); i++) {
            Ball ball1 = new Ball(Ass5Game.SCREEN_WIDTH / 2, Ass5Game.SCREEN_HEIGHT - REC_HEIGHT - 20, BALL_SIZE,
                    ballsAndPaddleColor, this.levInfo.initialBallVelocities().get(i), this.environment);
    ...
    public void initialize() {
        ...
        Rectangle rec = new Rectangle(new Point(0, 0), Ass5Game.SCREEN_WIDTH, REC_HEIGHT);
        ...
        this.pad.addToGame(this);
        // top border block.
        BorderBlock b = new BorderBlock(new Rectangle(new Point(0, 0 + REC_HEIGHT), Ass5Game.SCREEN_WIDTH,
        ...
        b = new BorderBlock(new Rectangle(new Point(0, BORDER_HEIGHT_OR_WIDTH + REC_HEIGHT), BORDER_HEIGHT_OR_WIDTH,
                Ass5Game.SCREEN_HEIGHT), Color.gray);
        b.addToGame(this);
        // right border block.
        b = new BorderBlock(new Rectangle(new Point(Ass5Game.SCREEN_WIDTH - BORDER_HEIGHT_OR_WIDTH,
                BORDER_HEIGHT_OR_WIDTH + REC_HEIGHT), BORDER_HEIGHT_OR_WIDTH, Ass5Game.SCREEN_HEIGHT), Color.gray);
        b.addToGame(this);
        // bottom border block
        Color removerC = ((Background) this.levInfo.getBackground()).getBackgroundColor();
        b = new BorderBlock(new Rectangle(new Point(BORDER_HEIGHT_OR_WIDTH, Ass5Game.SCREEN_HEIGHT
                - BORDER_HEIGHT_OR_WIDTH), Ass5Game.SCREEN_WIDTH - 2 * BORDER_HEIGHT_OR_WIDTH, BORDER_HEIGHT_OR_WIDTH),
                removerC);
        b.addHitListener(br);
        b.addToGame(this);
